...
int main(void)
{
    ...
    printf("Total payment for standard rectangular banner: %.2lf\n", Purchase(a, n));
    ...
    a.Reshape(true);
    printf("Total payment for customized triangular banner: %.2lf\n", Purchase(a, n));
    a.Reshape(Geometry::Elliptical);
    printf("Total payment for customized elliptical banner: %.2lf\n", Purchase(a, n));
}
