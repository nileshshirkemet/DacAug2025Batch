...
//this type of inheritance (is a relationship) in which the derived
//class defines additional members not present in base class which
//itself supports activation is called 'specialization'
